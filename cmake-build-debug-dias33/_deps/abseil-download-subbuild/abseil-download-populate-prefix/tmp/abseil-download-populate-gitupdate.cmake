...
execute_process(
  COMMAND "/usr/bin/git" show-ref "20230125.2"
  WORKING_DIRECTORY "/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/abseil-download-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("20230125.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/20230125.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/abseil-download-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/abseil-download-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
