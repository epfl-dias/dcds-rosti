...
execute_process(
  COMMAND "/usr/bin/git" show-ref "origin/v1.13.x"
  WORKING_DIRECTORY "/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/googletest-download-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "origin/v1.13.x")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("origin/v1.13.x" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/origin/v1.13.x")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/googletest-download-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/googletest-download-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
