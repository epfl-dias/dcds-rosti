...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.3"
  WORKING_DIRECTORY "/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/libcuckoo-download-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/libcuckoo-download-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/tmp/tmp.Y6NElX1M2E/cmake-build-debug-dias33/_deps/libcuckoo-download-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
